...
export function PriceCard({ title, price, features, onEnroll }) {
  return (
    <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-105">
      ...
      <div className="px-6 pb-6">
        {/* Call onEnroll when button is clicked */}
        <button
          onClick={onEnroll}
          className="w-full bg-primary text-white rounded-md py-2 font-semibold hover:bg-primary-700 transition-colors duration-300"
        >
          Choose Plan
        </button>
      </div>
