...
export default function Enquiry() {
    ...
    const handleSubmit = async (formData) => {
        try {
            if (!selectedRow?.id) {
                toast.error("Please select a valid row to reply to.");
                return;
            }
    ...
    const handleReply = () => {
        ...
        setIsModalOpen(true); 
            ...
            toast.warning("Select a row to reply!")
            setIsModalOpen(false);
        }
    };

    const columns = [
        { accessorKey: "id", header: "Enquiry ID" },
    ...
    return (
        <div className="h-screen">
            <div className="flex mt-3">
                ...
                <ActionButtons
                    actions={[
                        { onClick: handleReply, icon: Reply, text: "REPLY", disabled: !selectedRow  },
